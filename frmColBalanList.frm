...
'    frmBal.DatosADevolverBusqueda = True
'    frmBal.Show vbModal
'    Set frmBal = Nothing
'    If SQL <> "" Then
'        Me.txtBalan(Index).Text = RecuperaValor(SQL, 1)
'        Me.lblBalan(Index).Caption = RecuperaValor(SQL, 2)
'    Else
'        QuitarPulsacionMas Me.txtBalan(Index)
'    End If
'
'    PonFoco Me.txtBalan(Index)
