...
Begin VB.Form frmAsientosHco 
   ...
   Begin VB.Frame FrameFiltro 
      ...
      Begin VB.ComboBox cboFiltro 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmAsientosHco.frx":0000
         Left            =   90
         List            =   "frmAsientosHco.frx":000D
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         Left            =   1050
         TabIndex        =   72
         Tag             =   "fecha creacion|FH|S|||hcabapu|feccreacion|dd/mm/yyyy hh:mm:ss||"
         Text            =   "1234567890"
         Top             =   1260
         Width           =   3060
      End
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   0
         Left            =   2700
         Picture         =   "frmAsientosHco.frx":0044
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgppal 
   ...
   Begin VB.Frame FrameAux1 
      ...
      Begin VB.CommandButton cmdSaldoHco 
         ...
         Index           =   0
         Left            =   2910
         Picture         =   "frmAsientosHco.frx":6921
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.TextBox txtaux 
         ...
         MaxLength       =   15
         TabIndex        =   21
         Tag             =   "Concepto|T|S|||hlinapu|codconce|||"
         Text            =   "concepto"
         Top             =   2880
         Visible         =   0   'False
         Width           =   645
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    Dim Importe As Currency
        ...
        Case 11
                ...
                RC = "idsubcos"
                SQL = DevuelveDesdeBD("nomccost", "ccoste", "codccost", txtaux(11).Text, "T", RC)
                If SQL = "" Then
...
If Trim(Text2(2).Text) = "" Then
    ...
    frmActualizar.NumAsiento = CLng(Text1(0).Text)
    frmActualizar.FechaAsiento = CDate(Text1(1).Text)
    frmActualizar.NumDiari = CInt(Text1(2).Text)
    ...
    Else
        ...
        If Not DesbloquearAsiento(Text1(0).Text, Text1(2).Text, Format(Text1(1).Text, FormatoFecha)) Then
