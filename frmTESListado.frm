...
Begin VB.Form frmTESListado 
   ...
   Begin VB.Frame FrameCompensaAbonosCliente 
      ...
      Begin VB.CommandButton cmdVtoDestino 
         ...
         Index           =   0
         Left            =   240
         Picture         =   "frmTESListado.frx":DAB2
         Style           =   1  'Graphical
         TabIndex        =   488
         Top             =   5640
         Width           =   375
   ...
   Begin VB.Frame FrCobrosPendientesCli 
      ...
      Begin VB.ComboBox cboCobro 
         Height          =   315
         Index           =   1
         ItemData        =   "frmTESListado.frx":E4B4
         Left            =   9000
         List            =   "frmTESListado.frx":E4C1
      ...
      Begin VB.ComboBox cboCobro 
         Height          =   315
         Index           =   0
         ItemData        =   "frmTESListado.frx":E4D4
         Left            =   9000
         List            =   "frmTESListado.frx":E4E1
         Style           =   2  'Dropdown List
         TabIndex        =   21
         Top             =   4190
         Width           =   975
   ...
   Begin VB.Frame FrameCompensaciones 
      ...
      Begin VB.Image imgDiario 
         ...
         Index           =   0
         Left            =   1920
         Picture         =   "frmTESListado.frx":43186
         Top             =   3240
         Width           =   240
      End
      Begin VB.Label Label4 
