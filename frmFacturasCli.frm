...
Begin VB.Form frmFacturasCli 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   0
         Left            =   7500
         Picture         =   "frmFacturasCli.frx":00DF
         Top             =   210
         Width           =   240
      End
      Begin VB.Image imgppal 
...
Dim Rs As ADODB.Recordset
    ...
    If CargarCobrosTemporal(Text1(5).Text, Text1(1).Text, ImporteFormateado(Text1(13).Text)) Then
        ...
        If Not ExisteAlgunCobro(Text1(2).Text, Text1(0).Text, FecFactuAnt, False) Then
            ...
            frmCob.CodigoActual = CtaBanco & "|" & Entidad & "|" & Oficina & "|" & Control & "|" & Cuentaba & "|" & IBAN & "|" & TipForpa & "|" & NomBanco & "|"
            frmCob.Show vbModal
            Set frmCob = Nothing
...
Dim i As Integer
    ...
    For i = 0 To imgppal.Count - 1
        If i <> 0 And i <> 7 Then imgppal(i).Picture = frmPpal.ImageList3.ListImages(1).Picture
    Next i
...
Dim Sql4 As String
    ...
    While Not Rs.EOF
        ...
        Sql4 = "update cobros set numdiari = " & DBSet(FP.diaricli, "N")
        Sql4 = Sql4 & ", fechaent =  " & DBSet(FechaCobro, "F")
        Sql4 = Sql4 & ", numasien = " & DBSet(Mc.Contador, "N")
        Sql4 = Sql4 & ", usuariocobro = " & DBSet(vUsu.Nombre, "T")
        Sql4 = Sql4 & " where numserie = " & DBSet(Rs!NumSerie, "T")
        Sql4 = Sql4 & " and numfactu = " & DBSet(Rs!NumFactu, "N")
...
Dim SQL As String
    ...
    CadInsert = "insert into cobros (numserie,numfactu,fecfactu,numorden,codmacta,codforpa,fecvenci,impvenci," & _
                "ctabanc1,entidad,oficina,control,cuentaba,fecultco,impcobro,emitdocum,recedocu,contdocu," & _
                "text33csb,text41csb,ultimareclamacion,agente,departamento,transfer," & _
                "nomclien,domclien,pobclien,cpclien,proclien,iban) values "
    CadValues = ""
...
'            B = ContabilizarCobro
        ...
        SQL = SQL & DBSet(Text1(19).Text, "T", "S") & "," & DBSet(IBAN, "T", "S")
