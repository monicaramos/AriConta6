...
'        Donde = vParam.concefcl
'    Else
'        Donde = vParam.concefpr
'    End If
'
'    TipoConce = "tipoconce"
'    ConcFac = DevuelveDesdeBD("nomconce", "conceptos", "codconce", Donde, "N", TipoConce)
'    If ConcFac = "" And TipoConce = "tipoconce" Then
'          MsgBox "Concepto NO encontrado: " & Donde, vbExclamation
'          Exit Function
'    End If
'
'
    'Empezamos
    'Conn.Execute "Commit"  'Para que finalice todos los procesos anteriores y marque el punto del trans
...
'
'Private Sub TrataCadena(ByRef Cad As String)
'Dim I As Integer
'
''QUitamos las comas de texto '
'Do
'    I = InStr(1, Cad, "'")
'    If I > 0 Then
