...
Dim CtaEfectosComDescontados As String
    ...
    CtaParametros = DevuelveDesdeBD("ctaefectosdesc", "ctabancaria", "codmacta", RecuperaValor(CtaBanco, 1), "T", Cuenta)
        ...
        If LCta < vEmpresa.DigitosUltimoNivel Then
            ...
            If SQL <> "" Then
                ...
                If MsgBox(SQL, vbQuestion + vbYesNoCancel) = vbYes Then
                    ...
                    SQL = "Select codmacta," & Ampliacion & " from scobro WHERE codrem=" & Codigo & " AND anyorem = " & Anyo
...
Dim FecAsto As Date
    ...
    SQL = "Select fecvenci from scobro WHERE codrem=" & Codigo & " AND anyorem = " & Anyo & " GROUP BY fecvenci ORDER By fecvenci"
    RS.Open SQL, Conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    While Not RS.EOF
        SQL = RS.Fields(0)
        ColFechas.Add SQL
